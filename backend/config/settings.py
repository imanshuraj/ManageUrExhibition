...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', '127.0.0.1,localhost,manageurexhibition.onrender.com,manageurexhibitions.onrender.com,.onrender.com,.koyeb.app').split(',')
...
# 1. Priorities DATABASE_URL (for Koyeb/Render/Neon)
# 2. Defaults to local SQLite
DATABASES = {
...
# Fix for potential dj-database-url parsing issues with some database strings
